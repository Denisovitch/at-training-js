...
// Дана строка '2+3 223 2223'. Напишите регулярку, которая найдет строку 2+3,
...
console.log(
  `Today is the ${
    arrOfDaysW[now.getDay()]
  },  ${now.getDate()} of ${arrOfMonths[now.getMonth()]}, year ${now.getFullYear()}`
);